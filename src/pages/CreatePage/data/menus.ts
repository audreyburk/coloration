export const menus: {
  ...
  'Exit': [
    ...
    { fileName: 'entityDoorExit', index: 1 },
    { fileName: 'entityDoorExit', index: 2, space: true },
    { fileName: 'entityDoorExit', index: 3 },
    { fileName: 'entityDoorExit', index: 4, space: true },
    { fileName: 'entityDoorExit', index: 5 },
  ],
  'Exit Switch': [
    { fileName: 'entityDoorExitSwitch', index: 0 },
    { fileName: 'entityDoorExitSwitch', index: 3 },
    { fileName: 'entityDoorExitSwitch', index: 1, space: true },
  ...
  'Openable Doors': [
    ...
    { fileName: 'entityDoorLocked', index: 4, space: true },
    { fileName: 'entityDoorLocked', index: 7 },
    { fileName: 'entityDoorLocked', index: 2 },
    { fileName: 'entityDoorLocked', index: 5, space: true },
  ...
  'Kindly Objects': [
    ...
    { fileName: 'entityBounceBlock',    index: 1 },
    { fileName: 'entityOneWayPlatform', index: 0, space:true },
    { fileName: 'entityOneWayPlatform', index: 1 },
    { fileName: 'entityLaunchPad',      index: 0, space: true },
    { fileName: 'entityLaunchPad',      index: 1 },
    { fileName: 'entityBoostPad',       index: 0, space: true },
  ...
  'Zappy Drones': [
    ...
    { fileName: 'entityDroneZap', index: 1 },
    { fileName: 'entityDroneChaser', index: 0, space: true },
    { fileName: 'entityDroneChaser', index: 1 },
    { fileName: 'fxDroneZap', index: 0, space: true },
  ...
  'Mines': [
    ...
    { fileName: 'entityMine', index: 1 },
    { fileName: 'entityMine', index: 2, space: true },
    { fileName: 'entityMine', index: 3 },
  ],
  'Floorguard': [
    { fileName: 'entityFloorGuard', index: 0 },
    { fileName: 'entityFloorGuard', index: 1 },
    { fileName: 'fxFloorguardZap', index: 0, space: true },
  ...
  'Lasers': [
    ...
    { fileName: 'entityDroneLaser', index: 3 },
    { fileName: 'entityDualLaser',  index: 0, space: true },
    { fileName: 'entityDualLaser',  index: 1 },
  ],
  'Gauss Turret': [
    { fileName: 'entityTurret', index: 0 },
    { fileName: 'entityTurret', index: 1 },
    { fileName: 'entityTurret', index: 2, space: true },
  ...
  'Rocket Turret': [
    ...
    { fileName: 'entityRocket', index: 2, space: true },
  ...
  'Ninjas': [
    ...
    { fileName: 'ninja',      index: 3 },
    { fileName: 'headbands',  index: 0, space: true },
  ...
  'Ninja Effects': [
    ...
    { fileName: 'fxNinja',    index: 1 },
    { fileName: 'explosions', index: 3, space: true },
    { fileName: 'explosions', index: 0, space: true },
  ...
  'Ready Players': [
    ...
    { fileName: 'timeBarRace', index: 2, space: true }, // should these default to being linked to timebar color?
    { fileName: 'timeBarRace', index: 3 },
    { fileName: 'timeBarRace', index: 4 },
    { fileName: 'timeBarRace', index: 0, space: true },
  ],
  'Tabs': [
  ...
  'Episode Grid': [
    ...
    { fileName: 'menu',           index: 7, space: true },
    { fileName: 'menu',           index: 30 },
    { fileName: 'menu',           index: 5, space: true },
    { fileName: 'menu',           index: 23 },
    { fileName: 'entityDoorExit', index: 6, space: true },
    { fileName: 'menu',           index: 22, space: true },
  ],
  'Leaderboard': [
    { fileName: 'menu', index: 1 },
    { fileName: 'menu', index: 16, space: true },
  ...
  'Tabs and Subtabs': [
    ...
    { fileName: 'menu', index: 12, space: true },
    { fileName: 'menu', index: 33 },
    { fileName: 'menu', index: 37, space: true },
  ],
  'Levels': [
    { fileName: 'menu',           index: 35 },
    { fileName: 'timeBarRace',    index: 0, space: true },
    { fileName: 'timeBarRace',    index: 1 },
    { fileName: 'entityDoorExit', index: 7, space: true },
    { fileName: 'menu',           index: 22, space: true },
  ],
  'Bottom Text': [
